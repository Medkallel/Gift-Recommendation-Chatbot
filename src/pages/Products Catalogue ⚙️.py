...
if st.session_state.embed:
    st.error("This operation will overwrite the existing embedded documents. Are you sure you want to proceed? RECOVERY IS NOT POSSIBLE")
    if st.button("Yes, Proceed", type="secondary"):
        st.info("This may take a while depending on the size of the CSV file. Please be patient.")
